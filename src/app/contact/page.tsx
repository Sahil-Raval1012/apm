...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("success");
      setShowPopup(true);
      setFormData({ first_name: "", last_name: "", email: "", phone: "", service: "", message: "" });
    } catch (err) {
      console.error(err);
      setStatus("error");
    }
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      {/* Success Popup */}
      {showPopup && <SuccessPopup onClose={() => { setShowPopup(false); setStatus("idle"); }} />}
                ...
                <CardContent className="p-8 space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+61412391878" className="text-primary font-medium hover:underline">+61 412 391 878</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-primary shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Geelong, VIC</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-primary shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Servicing all metropolitan and regional areas.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="+61 400 000 000" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Tell us about your project..." className="min-h-[150px]" required />
                    </div>

                    {status === "error" && (
                      <p className="text-red-600 font-medium">❌ Something went wrong. Please try again or call us directly.</p>
                    )}
